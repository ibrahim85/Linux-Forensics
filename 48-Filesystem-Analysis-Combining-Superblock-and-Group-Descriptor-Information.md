#### 48. Filesystem Analysis: Combining Superblock and Group Descriptor Information
...
###### Read ```Superblock``` and ```Group Descriptor``` Information from an image file using ```extfs.py```
